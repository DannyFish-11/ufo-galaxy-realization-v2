...
CONFIG_SCHEMA: Dict[str, Dict[str, Any]] = {
    ...
    "GALAXY_AGENT_SUPPLY": {
        ...
        "type": "select",
        "category": "meta",
        "description": "子 Agent 按声明的需求选脑（on=声明了需求的按需求选脑、供不上就报，没声明的照旧 / shadow=每个都算、只记不用 / off=完全照旧 · 默认 on）",
    ...
    "GALAXY_META_RSI": {
        ...
        "type": "select",
        "category": "meta",
        "description": "自我改进循环（off=不跑 / shadow=只在隔离区验证、永不生效 / on=跑的时候，通过验证的补丁直接生效 · 默认 off）",
        "options": ["off", "shadow", "on"],
    },
