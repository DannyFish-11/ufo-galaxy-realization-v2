...
_ZH_DANGLING = (
    "然后", "接着", "再", "还有", "另外", "以及", "和", "或者", "或", "但是", "但",
    "不过", "因为", "所以", "如果", "要是", "就是", "那个", "这个", "呃", "嗯",
    "把", "给", "让", "帮我", "先", "比如", "还", "跟", "对了",
)
_EN_DANGLING = (
    "and", "or", "but", "so", "then", "also", "because", "if", "when", "like",
    "the", "a", "an", "to", "with", "for",
)
_DANGLING_PUNCT = ("，", ",", "、", "…", "——", "-", ":", "：")
# 明确"说完了"的收尾:问号/句号/叹号。
_TERMINAL_PUNCT = ("。", "？", "！", ".", "?", "!", "~", "～")
...
# ── hold(稍等别说话)──────────────────────────────────────────────────────────
_HOLD_PATTERNS = (
    "等一下", "等等", "稍等", "先别说话", "别说话", "让我想想", "让我看看",
    "安静一下", "闭嘴", "hold on", "one moment", "give me a moment",
    "let me think", "wait a sec", "be quiet",
)
_RESUME_PATTERNS = (
    "好了", "我说完了", "继续", "可以了", "在吗", "回来了",
    "ok go", "i'm back", "im back", "continue", "go ahead",
)
...
class DialogPolicy:
    ...
    _HEAVY_MARKERS = (
        "搜索", "搜一下", "搜下", "查一下", "查查", "查询", "帮我查", "联网",
        "帮我做", "帮我写", "帮我找", "帮我生成", "帮我下载", "帮我安装",
        "帮我部署", "帮我整理", "帮我分析", "帮我总结", "执行", "运行", "跑一下",
        "下载", "安装", "部署", "打开并", "整理一下", "分析一下", "总结一下",
        "search for", "look up", "find out", "download", "install", "deploy",
        "run the", "analyze", "summarize", "research",
    )
