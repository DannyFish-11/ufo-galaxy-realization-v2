...
__all__ = [
    ...
    "RECONCILER_RESULT_PAYLOAD_IS_FORWARDED_TO_TRACKER_POLICY",
    "ANDROID_EXECUTION_SIGNAL_RECONCILER_PR13_SENTINEL",
    # PR package 22: registry-backed reconciliation consolidation
    "RECONCILER_REGISTRY_GATE_PRECEDES_TRACKER_LOOKUP_POLICY",
    "RECONCILER_NON_ACTIVE_SESSION_IS_HARD_REJECTED_POLICY",
    "RECONCILER_PR22_SENTINEL",
    "AndroidSignalKind",
    ...
    "TERMINAL_STATE_IS_PROTECTED_AGAINST_REPLAY_POLICY",
    "CANONICAL_DELEGATED_EXECUTION_PATH_CLOSED_PR21_SENTINEL",
    # PR package 22: Registry-backed ingress consolidation (MAIN repo side)
    "INGRESS_REGISTRY_GATE_PRECEDES_RECONCILE_POLICY",
    "INGRESS_NON_ACTIVE_SESSION_IS_DROPPED_POLICY",
    "INGRESS_REGISTRY_CONSOLIDATION_PR22_SENTINEL",
    "DelegatedSignalKind",
    ...
    "REUSE_DISPATCH_DETACH_TRIGGERS_INELIGIBLE_RESOLUTION_POLICY",
    "ATTACHED_RUNTIME_REUSE_DISPATCH_PR17_SENTINEL",
    # PR package 22: registry-backed dispatch consolidation
    "REUSE_DISPATCH_REGISTRY_GATE_PRECEDES_BINDING_CHECK_POLICY",
    "REUSE_DISPATCH_NON_ACTIVE_REGISTRY_SESSION_IS_HARD_REJECTED_POLICY",
    "REUSE_DISPATCH_PR22_SENTINEL",
    "ReuseDispatchResolutionKind",
    ...
    "REGISTRY_LOOKUP_RETURNS_ACTIVE_ONLY_BY_DEFAULT_POLICY",
    "ATTACHED_RUNTIME_SESSION_REGISTRY_PR19_SENTINEL",
    # PR package 22: authoritative registry consolidation sentinels
    "REGISTRY_DISPATCH_GATE_IS_HARD_STOP_FOR_NON_ACTIVE_POLICY",
    "REGISTRY_REUSE_GATE_IS_HARD_STOP_FOR_NON_ACTIVE_POLICY",
    "REGISTRY_RECONCILIATION_GATE_IS_HARD_STOP_FOR_NON_ACTIVE_POLICY",
    "REGISTRY_REPLACED_SESSION_IS_NOT_ELIGIBLE_POLICY",
