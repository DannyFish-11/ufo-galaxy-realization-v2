    ...
    try:
        if participation_evidence:
            ...
            if target_device_id:
                ...
                _participation_evidence = _participation_truth_block.as_participation_evidence()
                _participation_tier_str = str(_participation_evidence.get("tier") or "local_only")
