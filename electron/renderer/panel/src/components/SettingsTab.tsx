...
const CONFIG_KEYS: Record<string, string[]> = {
  behavior: [
    ...
    // 连续感知
    'GALAXY_DESKTOP_PERCEPTION_TTL', 'GALAXY_PERCEPTION_KEYFRAMES', 'GALAXY_PERCEPTION_PRIVACY_DEFAULT',
    ...
    'GALAXY_LOCAL_AUDIO', 'GALAXY_NATIVE_MM_CHAT', 'GALAXY_CU_MEMORY', 'GALAXY_HITL_CONFIRM_GATE',
