...
| [`docs/PANEL_SURFACE_CONVERGENCE.md`](PANEL_SURFACE_CONVERGENCE.md) | `status_board_v2` is the sole canonical desktop surface and the canonical implementation surface for this topology (PR-0) |
