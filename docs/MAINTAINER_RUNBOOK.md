...
| Directory | Role | Description |
|-----------|------|-------------|
| `windows_client/status_board_v2/` | ACTIVE_DESKTOP_STATUS | Canonical operator-facing runtime surface; projection-driven with bounded control scope |
...
surface. It is projection-driven, operationally meaningful, and intentionally
bounded in exposed control authority.
...
| New desktop status display | `windows_client/status_board_v2/` (operator-facing runtime surface with bounded authority) |
