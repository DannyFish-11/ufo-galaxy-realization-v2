...
- `docs/TOPOLOGY_RENDERING_VISUAL_SEMANTICS.md` （已随面板表层收敛删除，见 `docs/PANEL_SURFACE_CONVERGENCE.md`） — PR-12
- `docs/TOPOLOGY_CONSTELLATION_LAYOUT.md` （已随面板表层收敛删除，见 `docs/PANEL_SURFACE_CONVERGENCE.md`） — PR-11
