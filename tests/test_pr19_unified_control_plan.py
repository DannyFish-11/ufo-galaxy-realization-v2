...
class TestAuthorityConstants:
    ...
    def test_constants_are_json_serialisable(self) -> None:
        from core.schemas.unified_control_plan import AUTHORITY_ROLE, ORCHESTRATION_ROLE, SHELL_ROLE, SUBSTRATE_ROLE
...
class TestAuthorityChain:
    def test_default_decision_authority_is_subject_decision_authority(self) -> None:
        from core.schemas.unified_control_plan import AUTHORITY_ROLE, AuthorityChain

        chain = AuthorityChain()
        assert chain.decision_authority == AUTHORITY_ROLE

    def test_default_shell_role(self) -> None:
        from core.schemas.unified_control_plan import SHELL_ROLE, AuthorityChain

        chain = AuthorityChain()
        assert chain.shell_role == SHELL_ROLE

    def test_default_substrate_role(self) -> None:
        from core.schemas.unified_control_plan import SUBSTRATE_ROLE, AuthorityChain
...
class TestAuthorityChainInvariant:
    ...
    def test_authority_chain_preserved_after_roundtrip(self) -> None:
        from core.schemas.unified_control_plan import AUTHORITY_ROLE, UnifiedControlPlan, build_unified_control_plan
    ...
    def test_shell_core_boundary_explicit_in_chain(self) -> None:
        from core.schemas.unified_control_plan import AUTHORITY_ROLE, SHELL_ROLE, build_unified_control_plan
...
class TestBuildUnifiedControlPlanTextOnly:
    ...
    def test_text_only_fallback_level_is_none(self) -> None:
        from core.schemas.unified_control_plan import FallbackLevel, build_unified_control_plan
...
class TestContinuumPostureDerivation:
    def test_no_continuum_gives_unknown_posture(self) -> None:
        from core.schemas.unified_control_plan import DecisionPosture, build_unified_control_plan
...
class TestShellCoreBoundary:
    ...
    def test_execution_substrate_distinct_from_decision_authority(self) -> None:
        from core.schemas.unified_control_plan import AUTHORITY_ROLE, SUBSTRATE_ROLE, build_unified_control_plan
...
class TestEdgeCasesFromDict:
    def test_unknown_decision_posture_degrades_to_unknown(self) -> None:
        from core.schemas.unified_control_plan import DecisionPosture, UnifiedControlPlan
    ...
    def test_unknown_fallback_level_degrades_to_unknown(self) -> None:
        from core.schemas.unified_control_plan import FallbackLevel, UnifiedControlPlan
