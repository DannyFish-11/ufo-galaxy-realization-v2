...
class TestCrossDevicePolicyIntegration:
    ...
    def test_device_role_enum_values(self):
        ...
        assert expected_roles <= actual_roles, f"Missing DeviceRole values: {expected_roles - actual_roles}"
    ...
    def test_routing_posture_enum_values(self):
        ...
        assert (
            expected_postures <= actual_postures
    ...
    def test_build_assignment_summary_none_returns_idle(self):
        from core.cross_device_policy import IDLE_ASSIGNMENT_SUMMARY, build_assignment_summary
