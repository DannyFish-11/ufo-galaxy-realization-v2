...
def test_endpoint_registration():
    ...
    expected_endpoints = ["/api/v1/command", "/api/v1/command/{request_id}/status"]
...
def test_models():
    ...
    from core.api_routes import CommandStatus, TargetResult, UnifiedCommandRequest, UnifiedCommandResponse
    ...
    request = UnifiedCommandRequest(
        command="test_command", targets=["device_1", "device_2"], params={"key": "value"}, mode="sync", timeout=30
    )
