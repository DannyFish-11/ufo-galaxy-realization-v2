...
_NODE_DIR = Path(__file__).resolve().parent.parent.parent / "nodes" / "Node_108_MetaCognition"


@pytest.mark.skip(reason=("Requires nodes/Node_108_MetaCognition/core/metacognition_engine " "— run manually"))
