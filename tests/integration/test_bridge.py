...
_BRIDGES_DIR = Path(__file__).resolve().parent.parent.parent / "enhancements" / "bridges"
...
async def test_error_handling(bridge):
    ...
    result = await bridge.unified_vision_analysis(image_path="/test/image.png", query="测试查询")
