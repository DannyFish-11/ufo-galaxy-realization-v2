...
from enhancements.monitoring.status_monitor import FeedbackCollector, MonitorLevel, StatusMonitor
...
from enhancements.safety.safety_manager import ErrorHandler, SafetyManager
...
async def test_full_execution():
    ...
    for i, tool_name in enumerate(tools):
        entity = Entity(
            ...
            properties={"version": "unknown", "path": "unknown", "capabilities": []},
        )
    ...
    safety_context = {
        ...
        "device_state": {
            ...
            "gps_fix": True,
            "altitude": 0.0,
            "temperature": {"bed": {"actual": 25.0}, "nozzle": {"actual": 25.0}},
        },
        "min_battery": 20.0,
        "max_altitude": 120.0,
    }
    ...
    try:
        ...
        execution_result = {"success": summary["success_rate"] > 0.5, "summary": summary}
        ...
        error_result = await error_handler.handle_execution_error(
            action_id="plan_execution", error=e, context={"plan": plan}
        )
