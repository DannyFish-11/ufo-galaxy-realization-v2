...
# 导入要测试的模块
from core.auth import require_auth, verify_api_token, verify_device_id
...
class TestPydanticModels(unittest.TestCase):
    ...
    def test_unified_command_request_defaults(self):
        ...
        request = UnifiedCommandRequest(command="test_command", targets=["device_1"])
...
class TestUnifiedCommandEndpoint:
    ...
    def test_unified_command_sync_mode_basic(self, client):
        """测试同步模式基本功能"""
        payload = {"command": "test_command", "targets": ["device_1"], "mode": "sync", "timeout": 10}
    ...
    def test_unified_command_async_mode_basic(self, client):
        """测试异步模式基本功能"""
        payload = {"command": "test_command", "targets": ["device_1"], "mode": "async"}
    ...
    def test_unified_command_invalid_mode(self, client):
        """测试无效的执行模式"""
        payload = {"command": "test_command", "targets": ["device_1"], "mode": "invalid_mode"}
    ...
    def test_unified_command_empty_targets(self, client):
        """测试空目标列表"""
        payload = {"command": "test_command", "targets": [], "mode": "sync"}
    ...
    def test_unified_command_custom_request_id(self, client):
        ...
        payload = {"request_id": custom_id, "command": "test_command", "targets": ["device_1"], "mode": "async"}
...
class TestUnifiedCommandEndpointWithAuth(unittest.TestCase):
    ...
    def test_command_without_auth(self):
        """测试未提供鉴权信息"""
        payload = {"command": "test_command", "targets": ["device_1"], "mode": "sync"}
    ...
    def test_command_with_device_id_header(self):
        ...
        headers = {"Authorization": "Bearer test-token-12345", "X-Device-ID": "my-device-001"}
