...
class TestRebalanceDecision:
    ...
    def test_to_dict(self):
        from core.device_formation.formation_rebalance_engine import MemberRebalanceAction, RebalanceDecision
...
class TestFormationRebalanceEngine:
    ...
    def test_primary_unhealthy_triggers_promotion(self):
        from core.device_formation.formation_rebalance_engine import FormationRebalanceEngine, MemberRebalanceAction
    ...
    def test_empty_formation_returns_noop(self):
        ...
        from core.device_formation.formation_rebalance_engine import EMPTY_FORMATION_GROUP, FormationRebalanceEngine
...
class TestConvenienceFunctions:
    ...
    def test_maybe_promote_fallback(self):
        ...
        roles = {getattr(m, "device_id", None): getattr(m, "role", None) for m in getattr(new_group, "members", [])}
