...
class TestBuildLocalTakeoverResult:
    def test_basic_fields(self):
        from contracts.local_takeover_result import LocalTakeoverStatus, build_local_takeover_result
...
class TestFromExecutionOutput:
    def test_success_output(self):
        from contracts.local_takeover_result import LocalTakeoverStatus, from_execution_output
