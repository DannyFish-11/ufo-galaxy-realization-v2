...
class TestSystemResourceRegistry:
    ...
    def test_register_replaces_existing(self):
        from core.system_resource import SystemResourceHealth, SystemResourceRecord
    ...
    def test_snapshot_structure(self):
        from core.system_resource import SystemResourceHealth, SystemResourceRecord, SystemResourceType
        ...
        reg.register(
            SystemResourceRecord(
                resource_id="snap2",
                health=SystemResourceHealth.UNAVAILABLE,
...
class TestSeederHelpers:
    ...
    def test_seed_github_idempotent(self):
        ...
        from core.system_resource import get_system_resource_registry, seed_github_resource
...
class TestDispatchResourceList:
    ...
    def test_list_filtered_by_type(self):
        from core.system_resource import seed_academic_resource, seed_engineering_resource, seed_github_resource
...
class TestDispatchResourceHealth:
    ...
    def test_health_update_valid(self):
        from core.system_resource import SystemResourceHealth, get_system_resource_registry, seed_github_resource

        seed_github_resource()
        oc = _make_openclawd()
        result = _run(
            oc._dispatch_resource_tool(
                "health",
                {
...
class TestAttributionSurvival:
    ...
    def test_github_source_attribution_fields(self):
        from core.system_resource import reset_system_resource_registry, seed_github_resource
    ...
    def test_academic_source_attribution_fields(self):
        from core.system_resource import reset_system_resource_registry, seed_academic_resource
    ...
    def test_device_source_attribution_fields(self):
        from core.system_resource import reset_system_resource_registry, seed_device_resource
