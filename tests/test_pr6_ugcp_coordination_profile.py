...
def test_sentinels_present() -> None:
    ...
    assert "COORDINATION_VOCABULARY_IS_FROZEN" in COORDINATION_VOCABULARY_IS_FROZEN_POLICY
    assert "AUTHORITY_MODEL_IS_CANONICAL" in COORDINATION_AUTHORITY_MODEL_IS_CANONICAL_POLICY
    assert "STATE_GRAPH_IS_CANONICAL" in COORDINATION_STATE_GRAPH_IS_CANONICAL_POLICY
    assert "build_coordination_durable_snapshot" in COORDINATION_TRUTH_AND_DURABLE_MAPPING_POLICY
