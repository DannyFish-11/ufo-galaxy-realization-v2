...
class TestRuntimePresenceSummaryProjection:
    def test_presence_summary_exposes_formal_desktop_presence_system(self):
        ...
        assert "hidden_context_visible_action_surface" in system_view
        ...
        hcas = system_view["hidden_context_visible_action_surface"]
        assert hcas["default_visibility_rules"]["background_by_default_not_foregrounded_by_default"] is True
        assert hcas["visible_action_surface"]["is_first_class_foreground_concept"] is True
