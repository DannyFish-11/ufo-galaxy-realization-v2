...
class TestF_IngressHarnessRecord(unittest.TestCase):
    ...
    def test_F02_to_dict_kind(self) -> None:
        from core.critical_path_harness import CriticalPathKind, IngressHarnessRecord
...
class TestG_RouteSelectionRecord(unittest.TestCase):
    ...
    def test_G01_default_construction(self) -> None:
        from core.critical_path_harness import PathHarnessState, RouteSelectionRecord
    ...
    def test_G02_to_dict_kind(self) -> None:
        from core.critical_path_harness import CriticalPathKind, RouteSelectionRecord
    ...
    def test_G04_to_dict_harness_state(self) -> None:
        ...
        rec = RouteSelectionRecord(route_type="advisory", harness_state=PathHarnessState.ADVISORY)
        d = rec.to_dict()
...
class TestH_ProviderSwitchRecord(unittest.TestCase):
    ...
    def test_H02_provider_selection_kind(self) -> None:
        from core.critical_path_harness import CriticalPathKind, ProviderSwitchRecord
    ...
    def test_H03_fallback_switch_kind(self) -> None:
        ...
        rec = ProviderSwitchRecord(from_provider="openai", to_provider="anthropic", is_fallback=True)
        d = rec.to_dict()
        self.assertEqual(d["kind"], CriticalPathKind.FALLBACK_SWITCH.value)

    def test_H04_fallback_state_is_fallback_active(self) -> None:
        from core.critical_path_harness import PathHarnessState, ProviderSwitchRecord
...
class TestI_ExecutionDispatchRecord(unittest.TestCase):
    ...
    def test_I02_to_dict_kind(self) -> None:
        from core.critical_path_harness import CriticalPathKind, ExecutionDispatchRecord
...
class TestJ_CriticalPathSnapshot(unittest.TestCase):
    ...
    def test_J02_summary_has_required_keys(self) -> None:
        ...
        snap = CriticalPathSnapshot(
            ingress_count=3,
            route_selection_count=3,
            provider_switch_count=2,
            dispatch_count=2,
            fallback_count=1,
            advisory_count=0,
            recent_route_type="native_multimodal",
            recent_provider="openai",
        )
        s = snap.summary()
        for key in (
            "ingress_count",
...
class TestK_SingletonManagement(unittest.TestCase):
    ...
    def test_K01_get_critical_path_harness_returns_instance(self) -> None:
        from core.critical_path_harness import CriticalPathHarnessRuntime, get_critical_path_harness
...
class TestM_RecordIngressPathHelper(unittest.TestCase):
    ...
    def test_M01_returns_ingress_record(self) -> None:
        from core.critical_path_harness import IngressHarnessRecord, record_ingress_path
    ...
    def test_M02_written_to_ring_buffer(self) -> None:
        from core.critical_path_harness import get_critical_path_harness, record_ingress_path
...
class TestN_RecordRouteSelectionHelper(unittest.TestCase):
    ...
    def test_N01_returns_route_selection_record(self) -> None:
        from core.critical_path_harness import RouteSelectionRecord, record_route_selection
    ...
    def test_N02_written_to_ring_buffer(self) -> None:
        from core.critical_path_harness import get_critical_path_harness, record_route_selection
    ...
    def test_N03_native_multimodal_state_is_completed(self) -> None:
        from core.critical_path_harness import PathHarnessState, record_route_selection
...
class TestO_RecordProviderSwitchSelection(unittest.TestCase):
    ...
    def test_O01_returns_provider_switch_record(self) -> None:
        from core.critical_path_harness import ProviderSwitchRecord, record_provider_switch
    ...
    def test_O02_written_to_ring_buffer(self) -> None:
        from core.critical_path_harness import get_critical_path_harness, record_provider_switch
...
class TestP_RecordProviderSwitchFallback(unittest.TestCase):
    ...
    def test_P01_fallback_is_fallback_true(self) -> None:
        ...
        rec = record_provider_switch(from_provider="openai", to_provider="anthropic", is_fallback=True)
        self.assertTrue(rec.is_fallback)

    def test_P02_fallback_in_fallback_records(self) -> None:
        from core.critical_path_harness import get_critical_path_harness, record_provider_switch

        record_provider_switch(from_provider="openai", to_provider="anthropic", is_fallback=True)
        fallbacks = get_critical_path_harness().get_fallback_records()
        self.assertEqual(len(fallbacks), 1)

    def test_P03_fallback_harness_state(self) -> None:
        from core.critical_path_harness import PathHarnessState, record_provider_switch
...
class TestQ_RecordExecutionDispatch(unittest.TestCase):
    ...
    def test_Q01_returns_execution_dispatch_record(self) -> None:
        from core.critical_path_harness import ExecutionDispatchRecord, record_execution_dispatch
    ...
    def test_Q02_written_to_ring_buffer(self) -> None:
        from core.critical_path_harness import get_critical_path_harness, record_execution_dispatch
...
class TestW_NonBlockingHarnessWrites(unittest.TestCase):
    ...
    def test_W01_record_ingress_path_does_not_raise(self) -> None:
        ...
        try:
            result = record_ingress_path(
                trace_id="w-01", active_modalities=["image"], requires_native_multimodal=True, source="test"
            )
    ...
    def test_W03_record_provider_switch_does_not_raise(self) -> None:
        ...
        try:
            result = record_provider_switch(from_provider="openai", to_provider="anthropic", is_fallback=True)
            self.assertIsNotNone(result)
        except Exception as exc:
...
class TestZ_Pr515LayerSpecs(unittest.TestCase):
    ...
    def test_Z02_critical_path_harness_authority_verified(self) -> None:
        from core.runtime_closure_audit import CLOSURE_STATUS_VERIFIED, get_runtime_closure_audit
...
class TestAA_OpenClawdSentinel(unittest.TestCase):
    ...
    def test_AA01_sentinel_importable(self) -> None:
        from core.openclawd import (  # type: ignore[attr-defined]  # noqa: F401
...
class TestCC_NoCompetingRoutingAuthority(unittest.TestCase):
    ...
    def test_CC04_harness_only_records(self) -> None:
        ...
        h = CriticalPathHarnessRuntime()
        record_methods = [m for m in dir(h) if m.startswith("record_")]
