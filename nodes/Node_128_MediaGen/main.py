...
class MediaGenService:
    ...
    def __init__(self, config: MediaGenConfig):
        """初始化服务"""
        self.node_name = "Node_128_MediaGen"
        self.config = config
...
if __name__ == "__main__":
    ...
    print("启动 Node_128_MediaGen 服务...")
    print("访问 http://127.0.0.1:8128/docs 查看 API 文档")
    uvicorn.run("__main__:app", host="0.0.0.0", port=8128, reload=True)
