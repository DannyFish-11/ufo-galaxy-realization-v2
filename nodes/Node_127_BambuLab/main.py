...
app = FastAPI(title="Node 127 - BambuLab", version="2.0.0")
...
install_node_auth(app, "Node_127_BambuLab")
...
@app.get("/health")
async def health():
    return {"status": "healthy" if paho else "degraded", "node_id": "127", "name": "BambuLab", "mqtt_available": paho is not None, "printer_configured": bool(PRINTER_IP and ACCESS_CODE), "timestamp": datetime.now().isoformat()}
