...
install_node_auth(app, "Node_110_SmartOrchestrator")
...
async def mcp_call(request: MCPCallRequest):
    ...
    if request.tool == "health":
        return {"success": True, "tool": request.tool, "result": {"status": "healthy", "node": "Node_110_SmartOrchestrator"}}
...
if __name__ == "__main__":
    ...
    try:
        ...
        _port = get_node_port("Node_110_SmartOrchestrator")
