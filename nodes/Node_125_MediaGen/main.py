...
class ImageHandler(BaseMediaHandler):
    ...
    async def generate(self, task: GenerationTask) -> str:
        ...
        svg = f'<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512"><rect fill="#f0f0f0" width="512" height="512"/><text x="50%" y="50%" text-anchor="middle" font-size="16">{task.prompt[:60]}</text></svg>'
