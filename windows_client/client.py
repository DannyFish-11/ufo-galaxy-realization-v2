# DEPRECATED — Legacy Windows client with bespoke Galaxy Gateway/AIP handling
#
# This module is no longer an active primary path.  The unified Windows
# device ingress is windows_aip_client.py.  All command execution routes
# through WindowsExecutionArbiter (core/windows_execution_arbiter.py).
#
# See docs/WINDOWS_EXECUTION_PIPELINE.md.
import warnings
warnings.warn(
    "windows_client/client.py is deprecated.  "
